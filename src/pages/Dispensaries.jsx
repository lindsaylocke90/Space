          ...
          return (
            <div key={d.id} className="bg-white rounded-xl shadow p-6">
              <div className="flex justify-between items-start">
                <div>
                  <h2 className="text-xl font-semibold text-stone-900">{d.name}</h2>
                  <p className="text-green-700 font-medium text-sm">{d.location}</p>
                </div>
              ...
              <div className="mt-4 pt-4 border-t border-stone-100">
                ...
                <div className="flex justify-between text-sm mt-1">
                  ...
                  <span className="font-semibold text-stone-800">{categoryCount}</span>
                </div>
              </div>

              <div className="mt-4 pt-4 border-t border-stone-100">
                <h3 className="text-sm font-semibold text-stone-700 mb-2">Products</h3>
                  ...
                  {d.products.map((p, i) => (
                    ...
                    >
                      <div>
                        ...
                        {p.strain && (
                          <span className="text-stone-500 ml-2">{p.strain}</span>
                        )}
                      </div>
